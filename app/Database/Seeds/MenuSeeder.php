...
class MenuSeeder extends Seeder
{
    public function run()
    {
        ...
        $menus = [
            ...
            array('option' => 'Tablero de requerimientos y recursos','url' => 'brand_defense','icon' => NULL,'position' => '1','type' => 'secundario','references' => '3','status' => 'active','component' => 'controller','title' => NULL,'description' => NULL,'table' => 'users'),
