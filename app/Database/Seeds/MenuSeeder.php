...
class MenuSeeder extends Seeder
{
    public function run()
    {
        ...
        $menus = [
            ...
            array('id' => '21','option' => 'Reporte de conflictividad','url' => 'vigiamarca/report','icon' => NULL,'position' => '2','type' => 'secundario','references' => '19','status' => 'active','component' => 'controller','title' => 'Reporte de conflictividad','description' => NULL,'table' => 'users'),
