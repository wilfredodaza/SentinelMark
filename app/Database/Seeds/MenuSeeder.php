...
class MenuSeeder extends Seeder
{
    public function run()
    {
        ...
        $menus = [
            ...
            array('id' => '15','option' => 'Calendario de plazos','url' => 'alertboard','icon' => NULL,'position' => '1','type' => 'secundario','references' => '5','status' => 'active','component' => 'controller','title' => 'Calendario de plazos','description' => NULL,'table' => 'users'),
            array('id' => '16','option' => 'Alerta y notificaciones','url' => 'alertboard/alerts','icon' => NULL,'position' => '2','type' => 'secundario','references' => '5','status' => 'active','component' => 'controller','title' => 'Alerta y notificaciones','description' => NULL,'table' => 'users'),
            array('id' => '17','option' => 'Reglas por país','url' => 'regulamark','icon' => NULL,'position' => '1','type' => 'secundario','references' => '6','status' => 'active','component' => 'controller','title' => 'Reglas por país','description' => NULL,'table' => 'users'),
            array('id' => '18','option' => 'Reglas aplicadas','url' => 'regulamark/history','icon' => NULL,'position' => '1','type' => 'secundario','references' => '6','status' => 'active','component' => 'controller','title' => 'Reglas aplicadas','description' => NULL,'table' => 'users'),
            ...
            array('id' => '20','option' => 'Panel de busqueda','url' => 'vigiamarca','icon' => NULL,'position' => '1','type' => 'secundario','references' => '19','status' => 'active','component' => 'controller','title' => 'Panel de busqueda de vigilancia','description' => NULL,'table' => 'users'),
            array('id' => '21','option' => 'Reporte de conflictividad','url' => 'vigiamarca/report','icon' => NULL,'position' => '3','type' => 'secundario','references' => '19','status' => 'active','component' => 'controller','title' => 'Reporte de conflictividad','description' => NULL,'table' => 'users'),
            array('id' => '22','option' => 'Panel de costo','url' => 'finances','icon' => NULL,'position' => '1','type' => 'secundario','references' => '7','status' => 'active','component' => 'controller','title' => 'Panel de costos','description' => NULL,'table' => 'users'),
            array('id' => '23','option' => 'Dashboard ROI','url' => 'finances/roi','icon' => NULL,'position' => '2','type' => 'secundario','references' => '7','status' => 'active','component' => 'controller','title' => 'Dashboard ROI','description' => NULL,'table' => 'users'),
            ...
            array('id' => '28','option' => 'Gacetas','url' => 'vigiamarca/gacetas','icon' => NULL,'position' => '2','type' => 'secundario','references' => '19','status' => 'active','component' => 'controller','title' => NULL,'description' => NULL,'table' => NULL)
        ];
